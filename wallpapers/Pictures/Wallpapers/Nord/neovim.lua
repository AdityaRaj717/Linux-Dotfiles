...
-- 1. FORCE DARK MODE (Nord is a Dark Theme)
...
-- =============================================================================
-- 2. PALETTE DEFINITION (Mapped from Nordic Blue vscode.json)
-- =============================================================================
local colors = {
	-- Base
	bg = "#2E3440", -- editor.background (Nord0)
	fg = "#ECEFF4", -- editor.foreground (Nord6)

	-- UI Surfaces
	sidebar = "#3B4252", -- sideBar.background (Nord1)
	line_bg = "#242933", -- editor.lineHighlightBackground (Darker than bg)
	highlight = "#4C566A", -- list.activeSelectionBackground (Nord3)
	selection = "#4C566A", -- editor.selectionBackground (Nord3)
	border = "#242933", -- editorGroup.border
	gutter = "#4C566A", -- editorLineNumber.foreground
	cursor = "#EBCB8B", -- editorCursor.foreground (Yellow)

	-- Syntax (From tokenColors)
	comment = "#4C566A", -- COMMENT (Nord3)
	cyan = "#88C0D0", -- FUNCTION (Nord8)
	blue = "#81A1C1", -- KEYWORD (Nord9)
	dark_blue = "#5E81AC", -- SELF (Nord10)
	teal = "#8FBCBB", -- ANNOTATION / TYPE (Nord7)
	green = "#A3BE8C", -- STRING (Nord14)
	red = "#BF616A", -- TAG / ERROR (Nord11)
	orange = "#D08770", -- PARAMETER (Nord12)
	yellow = "#EBCB8B", -- CONSTANT (Nord13)
	purple = "#B48EAD", -- NUMBER (Nord15)
	white_dim = "#D8DEE9", -- VARIABLE (Nord4)

	-- Diagnostics
	error = "#BF616A", -- editorError.foreground
	warn = "#EBCB8B", -- editorWarning.foreground
	info = "#81A1C1", -- notificationsInfoIcon.foreground
	hint = "#A3BE8C", -- editorHint.foreground

	-- Git
	git_add = "#A3BE8C", -- gitDecoration.addedResourceForeground
	git_change = "#88C0D0", -- gitDecoration.modifiedResourceForeground
	git_delete = "#BF616A", -- gitDecoration.deletedResourceForeground
}
...
local c = {
	...
	keyword = colors.blue, -- Keywords are Frost Blue
	var = colors.white_dim, -- Variables are Nord4 (slightly dimmer than FG)
	type = colors.teal, -- Types are Teal
...
set("CursorLineNr", { fg = colors.cyan, bold = true }) -- Active line number Cyan
...
set("Search", { bg = colors.selection, fg = colors.cyan, bold = true })
set("IncSearch", { bg = colors.orange, fg = colors.bg })
set("CurSearch", { link = "IncSearch" })
set("MatchParen", { fg = colors.yellow, bold = true, underline = true })
...
set("Number", { fg = colors.purple })
set("Boolean", { fg = colors.blue })
...
-- Git
set("DiffAdd", { bg = "#293630" })
set("DiffChange", { bg = "#293036" })
set("DiffDelete", { bg = "#362929" })
...
set("@variable.builtin", { fg = colors.dark_blue, italic = true })
set("@variable.parameter", { fg = colors.orange })
...
set("@tag", { link = "Tag" })
set("@tag.attribute", { fg = colors.green })
